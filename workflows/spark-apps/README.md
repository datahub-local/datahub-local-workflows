...
When `namespaceOverride` is set, the SparkApplication and all supporting resources are rendered into that namespace.
...
`imagePullSecrets` are applied to every rendered SparkApplication.
