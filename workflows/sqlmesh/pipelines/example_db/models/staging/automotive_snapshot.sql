MODEL (
  name example_db.automotive_snapshot,
  kind FULL,
  dialect spark,
  description 'Cleaned and typed automotive data. Strips whitespace, casts numeric fields, and drops rows without a make.'
);
...
FROM example_db.automotive_source
