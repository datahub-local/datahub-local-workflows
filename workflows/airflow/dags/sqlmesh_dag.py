...
COMMON_ENV_VARS = {
    "SQLMESH_STATE_HOST": "datahub-local-core-data-postgresql.data.svc.cluster.local",
    "SQLMESH_STATE_PORT": "5432",
    "SQLMESH_STATE_DB": "sqlmesh",
}
EXAMPLE_DB_ENV_VARS = {
    "NESSIE_REF": "main",
    "EXAMPLE_DB_URL": "jdbc:postgresql://datahub-local-core-data-postgresql.data.svc.cluster.local:5432/sqlmesh",
