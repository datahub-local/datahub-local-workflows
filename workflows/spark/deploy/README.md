...
- `src/launchers/spark_pipelines.py` as `mainApplicationFile`
- `python-deps.zip` as the Spark `deps.pyFiles` archive
- `src/pipelines/spark-pipeline.yml` as the declarative pipeline spec
- `src/pipelines/sql/*.sql` as the declarative dataset definitions loaded by Spark Declarative Pipelines
