...
|---|---|---|---|
| `homelab` (default) | Iceberg via Nessie REST + S3 (Garage) | Postgres | Parquet in temp bucket |
...
# Homelab target — Nessie / S3 / Postgres required
...
| `ICEBERG_CATALOG_URI` | `http://datahub-local-core-data-nessie:19120/iceberg/` | ingest (homelab) |
