...
- `workflows/spark/` is a Spark Declarative Pipeline project whose maintained source of truth is the data workflows.
...
For Spark workloads, develop and test from `workflows/spark/`, then render or deploy from `workflows/spark/deploy/`.
